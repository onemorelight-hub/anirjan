/**
 * ANIRJAN DATA STORE
 * Unified store for Products Ecosystem and Genesis Roadmap
...
const ANIRJAN_DEFAULT_DATA = {
  ...
  genesisGoals: [
    {
      id: "goal-1",
      target: "MoneyBook v1.0 Production Launch",
      category: "Software",
    ...
    },
    {
      ...
      status: "Hiring Now",
      progress: 20,
      description: "Bring on founding industrial designers and NGO coordinators with fair compensation and purpose.",
      quarter: "2026 - 2027"
    }
  ],
  products: [
